...
%type <_stmt> stmt
%type <_fieldDecl> field_decl field_decl_optional_static
...
%token BOOL_KW FLOAT_KW DOUBLE_KW DECIMAL_KW INT_KW CLASS_KW
...
program_element: stmt                          { printf("program_element -> stmt\n"); }
               ...
               | class_decl                    { printf("program_element -> class_decl\n"); }
;
...
standard_type: FLOAT_KW     { printf("standard_type -> FLOAT_KW\n"); }
             ...
             | INT_KW       { printf("standard_type -> INT_KW\n"); }
;

type: standard_type     { printf("type -> standard_type\n"); }
    | class_name        { printf("type -> class_name\n"); }
;
...
access_expr: '(' expr ')'                                        { printf("access_expr -> ( expr )\n"); }
           ...
           | NULL_KW                                             { printf("access_expr -> NULL_KW\n"); }
...
expr: expr '+' expr                       { printf("expr -> expr + expr\n"); }
    ...
    | expr '%' expr                       { printf("expr -> expr %% expr\n"); }
    | expr '=' expr                       { printf("expr -> expr = expr\n"); }
    | expr PLUS_ASSIGN expr               { printf("expr -> expr PLUS_ASSIGN expr\n"); }
    | expr MINUS_ASSIGN expr              { printf("expr -> expr MINUS_ASSIGN expr\n"); }
    | expr MULTIPLY_ASSIGN expr           { printf("expr -> expr MULTIPLY_ASSIGN expr\n"); }
    | expr DIVISION_ASSIGN expr           { printf("expr -> expr DIVISION_ASSIGN expr\n"); }
    | expr '<' expr                       { printf("expr -> expr < expr\n"); }
    | expr '>' expr                       { printf("expr -> expr > expr\n"); }
    | expr EQUAL expr                     { printf("expr -> expr EQUAL expr\n"); }
    | expr NOT_EQUAL expr                 { printf("expr -> expr NOT_EQUAL expr\n"); }
    | expr LESS_OR_EQUAL expr             { printf("expr -> expr LESS_OR_EQUAL expr\n"); }
    | expr GREATER_OR_EQUAL expr          { printf("expr -> expr GREATER_OR_EQUAL expr\n"); }
    | expr AND expr                       { printf("expr -> expr AND expr\n"); }
    | expr OR expr                        { printf("expr -> expr OR expr\n"); }
    | expr BITWISE_AND expr               { printf("expr -> expr BITWISE_AND expr\n"); }
    | expr BITWISE_OR expr                { printf("expr -> expr BITWISE_OR expr\n"); }
    | '!' expr                            { printf("expr -> ! expr\n"); }
    | INCREMENT expr                      { printf("expr -> INCREMENT expr\n"); }
    | DECREMENT expr                      { printf("expr -> DECREMENT expr\n"); }
    | '+' expr %prec UNARY_PLUS           { printf("expr -> + expr UNARY_PLUS\n"); }
    | '-' expr %prec UNARY_MINUS          { printf("expr -> - expr UNARY_MINUS\n"); }
    | access_expr                         { printf("expr -> access_expr\n"); }
;
...
class_members: field_decl                              { printf("class_members -> field_decl\n"); }
            | method_decl                              { printf("class_members -> method_decl\n"); }
            | constructor_decl                         { printf("class_members -> constructor_decl\n"); }
            | destructor_decl                          { printf("class_members -> destructor_decl\n"); }
            | class_members field_decl                 { printf("class_members -> class_members field_decl\n"); }
            | class_members method_decl                { printf("class_members -> class_members method_decl\n"); }
            | class_members constructor_decl           { printf("class_members -> class_members constructor_decl\n"); }
            | class_members destructor_decl            { printf("class_members -> class_members destructor_decl\n"); }
;

class_members_optional: /* empty */       { printf("class_members_optional -> empty\n"); }
                      | class_members      { printf("class_members_optional -> class_members\n"); }
;

class_decl: visibility_modifier CLASS_KW class_name '{' class_members_optional '}' { printf("class_decl -> visibility_modifier CLASS_KW class_name\n"); }
;
...
struct_decl: visibility_modifier STRUCT class_name '{' struct_members_optional '}' { printf("struct_decl -> visibility_modifier STRUCT class_name\n"); }
;
...
field_decl_optional_static: visibility_modifier var_decl ';' { printf("field_decl_optional_static -> visibility_modifier var_decl ;\n"); }
                          | visibility_modifier STATIC var_decl ';' { printf("field_decl_optional_static -> visibility_modifier STATIC var_decl ;\n"); }
;

field_decl: field_decl_optional_static { printf("field_decl -> field_decl_optional_static\n"); }
;
...
enum_decl: visibility_modifier ENUM class_name '{' enumerators '}' { printf("enum_decl -> visibility_modifier ENUM class_name\n"); }
;
