...
struct WhileNode final : Node
{
    ...
    [[nodiscard]] std::string  Name() const noexcept override { return "While"; }
};
...
struct DoWhileNode final : Node
{
    ...
    [[nodiscard]] std::string  Name() const noexcept override { return "DoWhile"; }
};
...
struct ForNode final : Node
{
    ...
    [[nodiscard]] std::string  Name() const noexcept override { return "For"; }
};
...
struct ForEachNode final : Node
{
    ...
    [[nodiscard]] std::string  Name() const noexcept override { return "Foreach"; }
};
...
struct StmtSeqNode final : NodeSeq<StmtSeqNode, StmtNode>
{
    ...
    explicit StmtSeqNode(StmtNode* stmt) : NodeSeq<StmtSeqNode, StmtNode>(stmt) {}
...
struct IfNode : Node
{
    ...
    [[nodiscard]] std::string  Name() const noexcept override { return "If"; }
};
...
struct StmtNode final : Node
{
    ...
    [[nodiscard]] std::string  Name() const noexcept override { return "Stmt"; }
};
