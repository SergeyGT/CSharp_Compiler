...
%type <_memberDecl> member_decl member_tail
...
program_element: stmt                			{ printf("program_element -> stmt\n"); }
               ...
               | member_decl                    { printf("program_element -> member_decl\n"); }
...
static_modifier: STATIC { printf("static_modifier -> STATIC\n"); }

static_modifier_optional: /* empty */     { printf("static_modifier_optional -> empty\n"); }
                        | static_modifier { printf("static_modifier_optional -> static_modifier\n"); }
;

constructor_decl: visibility_modifier class_name '(' method_arguments_optional ')' '{' stmt_seq_optional '}' 
...
interpolated_string_content: /* empty */     												
...
member_decl: visibility_modifier static_modifier_optional type IDENTIFIER member_tail
    { printf("member_decl -> visibility_modifier static_modifier_optional type IDENTIFIER member_tail\n"); }
;

member_tail: '(' method_arguments_optional ')' '{' stmt_seq_optional '}'   
